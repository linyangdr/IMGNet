...
def parse_agrs():
    ...
    parser.add_argument('--resume', type=str, default="results/iu_xray/model_best.pth",help='whether to resume the training from existing checkpoints.')
    parser.add_argument('--load', type=str,default="results/iu_xray/model_best.pth", help='whether to load the pre-trained model.')
