...
class Trainer(BaseTrainer):
    def __init__(self, model, criterion, metric_ftns, ve_optimizer, ed_optimizer, args, train_dataloader,
        ...
        self._train_epoch = self._train_epoch_IU_Xray
    ...
    def _train_epoch_IU_Xray(self, epoch):
        ...
        for batch_idx, (images_id,
            ...
            _,output, _, _, _, _ = self.model(images = images,
        ...
        with torch.no_grad():
            ...
            for batch_idx, (images_id,
                        ...
                        reports_masks,
                        labels,
                        disease_detected) in enumerate(self.val_dataloader):
