...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default=IMAGE_DIR, help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default=ANN_PATH, help='the path to the directory containing the data.')
    parser.add_argument('--label_path', type=str, default=LABEL_PATH,help='the path to the directory containing the data.')
    parser.add_argument('--init_protypes_path', type=str, default=INIT_PROTYPES_PATH,help='the path to the directory containing the data.')

    # Data loader settings
    parser.add_argument('--dataset_name', type=str, default=DATASET_NAME, choices=['iu_xray', 'mimic_cxr'], help='the dataset to be used.')
    parser.add_argument('--max_seq_length', type=int, default=MAX_SEQ_LENGTH, help='the maximum sequence length of the reports.')
    parser.add_argument('--threshold', type=int, default=THRESHOLD, help='the cut off frequency for the words.')
    parser.add_argument('--num_workers', type=int, default=2, help='the number of workers for dataloader.')
    parser.add_argument('--batch_size', type=int, default=BATCH_SIZE, help='the number of samples for a batch')
    ...
    parser.add_argument('--num_layers', type=int, default=NUM_LAYERS, help='the number of layers of Transformer.')
    ...
    parser.add_argument('--d_txt_ebd', type=int, default=D_TXT_EBD, help='the dimension of extracted text embedding.')
    parser.add_argument('--d_img_ebd', type=int, default=D_IMG_EBD, help='the dimension of extracted img embedding.')

    # for Cross-modal Memory
    parser.add_argument('--topk', type=int, default=TOPK, help='the number of k.')
    ...
    parser.add_argument('--log_period', type=int, default=LOG_PERIOD, help='the logging interval (in batches).')
    ...
    parser.add_argument('--early_stop', type=int, default=EARLY_STOP, help='the patience of training.')
    ...
    parser.add_argument('--noamopt_warmup', type=int, default=1000, help='.')
    ...
    parser.add_argument('--step_size', type=int, default=STEP_SIZE, help='the step size of the learning rate scheduler.')
    parser.add_argument('--gamma', type=float, default=GAMMA, help='the gamma of the learning rate scheduler.')
    ...
    parser.add_argument('--resume', type=str, default=RESUME,help='whether to resume the training from existing checkpoints.')
